...
- [ ] T052 Run the SC-002 reading trial with a team member who did not watch the run (needs a person) and record it in `specs/004-sonavida-persona-life/checklists/sc-002-trial.md` — *Deferred by the Visionary (2026-09-25): run the trial later, with a team member who did not watch a run; spec 004 is otherwise closed.*
